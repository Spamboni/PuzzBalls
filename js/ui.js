window.PUZZBALLS_FILE_VERSION = window.PUZZBALLS_FILE_VERSION || {}; window.PUZZBALLS_FILE_VERSION['ui.js'] = 1462;
  ...
  _buildSettingsPanel() {
    ...
    tabs.forEach(function(t, idx) {
      ...
      if (t.id === 'version') {
        ...
        vRow.innerHTML = '<b>PuzzBalls v14.62</b>';
        ...
        files.forEach(function(f) {
          ...
          var verEl = _el('span','');
          if (loaded === undefined) {
            verEl.textContent = f === 'index.html' ? 'v14.62 (this page)' : 'not stamped';
            verEl.style.color = '#888';
          } else if (loaded === 1462) {
            verEl.textContent = 'v14.62 ✓';
        ...
        instrRow.innerHTML = '<b style="color:#00ffee">⚠ If files show old version:</b><br>' +
          ...
          'Or open the URL then add <b>?v=1462</b> to the end and reload.';
