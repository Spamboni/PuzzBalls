window.PUZZBALLS_FILE_VERSION = window.PUZZBALLS_FILE_VERSION || {}; window.PUZZBALLS_FILE_VERSION['ui.js'] = 1456;
  ...
  _buildSettingsPanel() {
    ...
    tabs.forEach(function(t, idx) {
      ...
      if (t.id === 'version') {
        ...
        vRow.innerHTML = '<b>PuzzBalls v14.56</b>';
        ...
        files.forEach(function(f) {
          ...
          var verEl = _el('span','');
          if (loaded === 1456undefined) {
            verEl.textContent = f === 'index.html' ? 'v14.56 (this page)' : 'not stamped';
            verEl.style.color = '#888';
          } else if (loaded === 1456) {
            verEl.textContent = 'v14.56 ✓';
