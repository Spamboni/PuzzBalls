window.PUZZBALLS_FILE_VERSION = window.PUZZBALLS_FILE_VERSION || {}; window.PUZZBALLS_FILE_VERSION['ui.js'] = 1507;
  ...
  _buildSettingsPanel() {
    ...
    tabs.forEach(function(t, idx) {
      ...
      if (t.id === 'version') {
        ...
        vRow.innerHTML = '<b>PuzzBalls v15.07</b>';
        ...
        files.forEach(function(f) {
          ...
          var verEl = _el('span','');
          if (loaded === undefined) {
            verEl.textContent = f === 'index.html' ? 'v15.07 (this page)' : 'not stamped';
            verEl.style.color = '#888';
          } else if (loaded === 1506) {
            verEl.textContent = 'v15.07 ✓';
