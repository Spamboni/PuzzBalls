window.PUZZBALLS_FILE_VERSION = window.PUZZBALLS_FILE_VERSION || {}; window.PUZZBALLS_BUILD_TIMESTAMP = 'v16.05 2026-04-11';
window.PUZZBALLS_FILE_VERSION['menu.js'] = 1605;
...
var Menu = (function() {
  ...
  function _render() {
    ...
    header.innerHTML = '<div class="menu-logo">PUZZBALLS</div><div class="menu-tagline">Physics • Puzzles • Mayhem</div><div class="menu-version" style="color:#ffff00">' + _BUILD_TIME + '</div>';
